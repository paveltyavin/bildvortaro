...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Word.thumb_150'
        db.add_column(u'app_word', 'thumb_150',
                      self.gf('django.db.models.fields.files.ImageField')(default='', max_length=100),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Word.thumb_150'
        db.delete_column(u'app_word', 'thumb_150')
    ...
    models = {
        ...
        u'app.word': {
            ...
            'date_created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 7, 8, 0, 0)'}),
            'date_modified': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 7, 8, 0, 0)'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
