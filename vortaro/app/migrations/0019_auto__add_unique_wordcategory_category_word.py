...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'WordCategory', fields ['category', 'word']
        db.create_unique(u'app_wordcategory', ['category_id', 'word_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'WordCategory', fields ['category', 'word']
        db.delete_unique(u'app_wordcategory', ['category_id', 'word_id'])
    ...
    models = {
        ...
        u'app.word': {
            ...
            'date_created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 7, 11, 0, 0)'}),
            'date_modified': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 7, 11, 0, 0)'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        u'app.wordcategory': {
            'Meta': {'unique_together': "(('category', 'word'),)", 'object_name': 'WordCategory'},
            'category': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'words'", 'to': u"orm['app.Word']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'word': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'categories'", 'to': u"orm['app.Word']"}),
