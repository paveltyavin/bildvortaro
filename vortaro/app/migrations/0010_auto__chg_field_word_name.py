...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'app_word', 'name', self.gf('django.db.models.fields.CharField')(max_length=128, unique=True, null=True))

    def backwards(self, orm):

        # Changing field 'Word.name'
        db.alter_column(u'app_word', 'name', self.gf('django.db.models.fields.CharField')(default='1', max_length=128, unique=True))

    models = {
        u'app.category': {
            'Meta': {'ordering': "('order',)", 'object_name': 'Category'},
            'date_created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 4, 1, 0, 0)'}),
            'date_modified': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 4, 1, 0, 0)'}),
