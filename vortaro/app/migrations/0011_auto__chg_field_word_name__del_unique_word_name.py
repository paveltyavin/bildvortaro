...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_unique(u'app_word', ['name'])


        # Changing field 'Word.name'
        db.alter_column(u'app_word', 'name', self.gf('django.db.models.fields.CharField')(default='', max_length=128))

    def backwards(self, orm):

        # Changing field 'Word.name'
        db.alter_column(u'app_word', 'name', self.gf('django.db.models.fields.CharField')(unique=True, max_length=128, null=True))
        # Adding unique constraint on 'Word', fields ['name']
        db.create_unique(u'app_word', ['name'])


    models = {
        u'app.category': {
            'Meta': {'ordering': "('order',)", 'object_name': 'Category'},
            'date_created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 4, 2, 0, 0)'}),
            'date_modified': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 4, 2, 0, 0)'}),
